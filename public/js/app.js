$(document).ready(function(){
    //initial job list
    var jobs;
    loadData = function(url1) { $.getJSON(url1, function(data){ 
...
<div class="row"><div class="col-xs-10 "><h4 ><a href="index.php/job/'+obj.id+'">'+obj.name+'</a></h4>\n\
...
<p>'+date.getDate()+'/'+(date.getMonth()+1)+'/'+date.getFullYear()+'</p></div></div>');
    ...
    loadSelectors = function (url2, sel_id, type) {$.getJSON(url2, function(data){ 
        if (data.statusCode === 200) {
