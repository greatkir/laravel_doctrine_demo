...
class JobController extends Controller
{
    ...
    public function index(Request $request, $offset = null)
    {
        try {
            ...
            $links       = [];
            $criteria    = $this->paramsCriteria($request);
            ...
            $links = $this->navigationLinks($criteria, $limit, $offset);
        } catch (Exception $e) {
     ...
     * @return array
     */
    private function navigationLinks($criteria, $limit, $offset)
    {
        $links = [];
     ...
     * @return array
     */
    private function paramsCriteria($request)
    {
        $criteria = [];
        if ($request->has('name')) {
